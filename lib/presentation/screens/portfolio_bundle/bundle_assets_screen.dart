...
class BundleAssetsScreen extends ConsumerWidget {
  final String bundleName;
  final List<int> portfolioIds;

  const BundleAssetsScreen({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final assetsAsync = ref.watch(bundleAssetsProvider(portfolioIds));
...
class _AssetTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final titleText = isKr ? asset.name : asset.symbol;
    final subtitleText =
